...
exports.run = (client, message, args) => {
  if(!message.member.roles.cache.has("856278189513244703") && !message.member.hasPermission("ADMINISTRATOR"))
    return message.channel.send(
      "<a:carpi:856475633339990037>  Bu komutu kullanabilmek için `Emojileri yönet` yetkisine sahip olmalısınız"
    );
  let link = args[0];
  let isim = args[1];
